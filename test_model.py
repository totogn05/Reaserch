...
def test_cnn():
    ...
    train_ds, test_ds, class_names = data_load("../GLCM_Test_picture/Mean/train",
                                              "../GLCM_Test_picture/Mean/test",  224, 224, 3)
    # todo 加载模型，修改为你的模型名称
    model = tf.keras.models.load_model('Mean_cnn.h5')
    # model.summary()
    # 测试
    ...
    show_heatmaps(title="heatmap", x_labels=class_names, y_labels=class_names, harvest=heat_maps_float,
                  save_name="results/GLCM_result_cnn.png")
